package com.god.api.baidu.map.service;
...
public interface IMapBaiduService {
	 ...
	 * @return
	 */
	public abstract MapBaiduResponse<MapBaiduDrivingResult> getDriving(MapBaiduLngLat origin, MapBaiduLngLat destination );
